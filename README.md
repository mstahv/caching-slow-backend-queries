# Example: caching slow backend methods

This is an example project how one can work around slow backend queries
with a caching library like Ehcache. This version uses Ehcache API
directly. A related blog post and a version with Spring's Cacheable 
annotation on their way...
